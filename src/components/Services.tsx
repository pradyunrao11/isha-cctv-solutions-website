...
export default function Services() {
  return (
    <section id="services" className="py-24 bg-blue-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="mt-16 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((s, i) => (
            <div
              key={s.title}
              className="group relative p-7 rounded-2xl bg-blue-950 border border-blue-900 hover:border-blue-500/50 transition-all duration-300 hover:-translate-y-1 overflow-hidden"
              style={{ animationDelay: `${i * 80}ms` }}
            >
              <div className="absolute -top-12 -right-12 w-32 h-32 bg-blue-600/10 rounded-full blur-2xl group-hover:bg-blue-500/20 transition-colors" />
              <div className="relative w-14 h-14 rounded-xl bg-gradient-to-br from-blue-600/20 to-yellow-500/10 border border-blue-500/20 flex items-center justify-center mb-5 group-hover:from-blue-600/30 group-hover:to-yellow-500/20 transition-colors">
