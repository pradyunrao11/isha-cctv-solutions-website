...
export default function WhyChooseUs() {
  return (
    <section id="why-us" className="py-24 bg-[#071A3D] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {reasons.map((r) => (
            <div
              key={r.title}
              className="group relative p-7 rounded-2xl bg-gradient-to-br from-[#071A3D] to-[#071A3D]/80 border border-blue-900 hover:border-yellow-500/40 transition-all duration-300"
            >
