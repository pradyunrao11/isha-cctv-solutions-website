          ...
          <div>
            ...
            <div className="mt-10 space-y-5">
              {[
                ...
                { icon: Mail, label: 'Email Us', value: 'info@ishhacctv.com', href: 'mailto:info@ishhacctv.com' },
                { icon: MapPin, label: 'Visit Us', value: '123 Business District, Industrial Area, Mumbai 400001', href: '#' },
              ].map((c) => (
                <a
                  key={c.label}
                  href={c.href}
            ...
            <div className="mt-8 p-5 rounded-xl bg-blue-950 border border-blue-900">
