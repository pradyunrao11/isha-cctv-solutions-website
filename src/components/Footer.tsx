        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-blue-900">
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-yellow-400 flex items-center justify-center">
            ...
            <div className="flex gap-3 mt-5">
              {[Facebook, Twitter, Instagram, Linkedin].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="w-9 h-9 rounded-lg bg-blue-900 border border-blue-800 flex items-center justify-center text-slate-300 hover:text-yellow-300 hover:border-yellow-500/40 transition-colors"
                >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-sm text-blue-100">
                ...
                123 Business District, Industrial Area, Mumbai 400001
              </li>
