          ...
          {filtered.map((p) => (
            ...
            >
              <div className="relative h-52 overflow-hidden">
                ...
                <span className="absolute top-3 right-3 px-2.5 py-1 rounded-md bg-blue-950/80 backdrop-blur-sm text-[10px] font-semibold text-blue-100 border border-blue-800">
                  {p.brand}
                </span>
              </div>
