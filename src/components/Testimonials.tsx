...
export default function Testimonials() {
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      <div className="absolute top-1/4 right-0 w-96 h-96 bg-[#0B2552]/5 rounded-full blur-3xl" />
          ...
          {testimonials.map((t) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-slate-200">
                <div className="w-11 h-11 rounded-full bg-gradient-to-br from-[#0B2552] to-yellow-500 flex items-center justify-center text-white font-bold text-sm">
